import numpy as np
import nimopy.ai_tools
import nimopy.input_tools
import nimopy.output_tools
...
class preparation_input():
    ...
    def module_selection(self):
        ...
        if self.machine == "STAN":
            res = nimopy.input_tools.preparation_input_standard.Standard(self.input_file, self.input_folder).perform()
            return res

        #if self.machine == "NAREE":
        #    res = nimopy.input_tools.preparation_input_naree.NAREE(self.input_file, self.input_folder).perform()
        #    return res

        #if self.machine == "COMBAT":
        #    res = nimopy.input_tools.preparation_input_combat.COMBAT(self.input_file, self.input_folder).perform()
        #    return res
...
class analysis_output():
    ...
    def module_selection(self):
        ...
        if self.machine == "STAN":
            res = nimopy.output_tools.analysis_output_standard.Standard(self.input_file, self.output_file, self.num_objectives, self.output_folder).perform()
            return res

        #if self.machine == "NAREE":
        #    res = nimopy.output_tools.analysis_output_naree.NAREE(self.input_file, self.output_file, self.num_objectives, self.output_folder, self.objectives_info).perform()
        #    return res

        #if self.machine == "COMBAT":
        #    res = nimopy.output_tools.analysis_output_combat.COMBAT(self.input_file, self.output_file, self.num_objectives, self.output_folder).perform()
        #    return res
...
class output_update():
    ...
    def __init__(self, input_file, output_file, num_objectives, objective_values):
        ...
        res = nimopy.output_tools.analysis_output_update.Update(input_file = self.input_file, 
...
class analysis():
    ...
    def module_selection(self):
        ...
        res = 'False'
        if self.method == "WAM":
            res = nimopy.ai_tools.ai_tool_slesa_WAM.SLESA_WAM(self.input_file, 
